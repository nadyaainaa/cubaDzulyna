...
@section('content')
               ...
               <div class="row g-4 align-items-center justify-content-between align-items-center">
                    ...
                    <div class="col-lg-5 wow fadeInUp" data-wow-delay=".4s">
                       <div class="hero-image">
                           <img src="{{ asset('assets/img/hero/digital-marketing-hero-img-min.png') }}" alt="img">
        ...
        <section class="service-section-4 fix bg-cover section-padding" id="services" style="background-image: url('{{ asset('assets/img/service/service-bg-min.jpg') }}')">
            <div class="container">
        ...
        <section class="contact-section fix section-padding pt-0 fix" id="contact">
