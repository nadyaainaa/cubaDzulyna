...
@section('content')
                    ...
                    <div class="col-lg-6">
                        <div class="hero-content">
                            ...
                            <div class="hero-button">
                                <a href="{{ route('about') }}" class="theme-btn wow fadeInUp" data-wow-delay=".7s">Discover More <i class="far fa-arrow-right"></i></a>
                                <a href="{{ route('service') }}" class="btn-link wow fadeInUp" data-wow-delay=".8s">View Services <i class="far fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="hero-image">
                           <img src="{{ asset('assets/img/hero/hero-1.png') }}" alt="img">
                            <div class="frame-shape">
                               <img src="{{ asset('assets/img/hero/frame-3.png') }}" alt="shape-img">
                            </div>
                            <div class="bcleft-shape float-bob-x">
                               <img src="{{ asset('assets/img/hero/bcleft.png') }}" alt="shape-img">
                            </div>
                            <div class="bcright-shape float-bob-y">
                               <img src="{{ asset('assets/img/hero/bcright.png') }}" alt="shape-img">
                            </div>
                            <div class="message-shape">
                               <img src="{{ asset('assets/img/hero/message.png') }}" alt="shape-img">
                            </div>
                        </div>
                    </div>
               </div>
        ...
        <section class="service-offer-section" id="services">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="service-offer-items">
                            <div class="icon">
                               <img src="{{ asset('assets/img/service/icon/brainstorming.svg') }}" alt="img">
                            </div>
                            <div class="offer-content">
                                <div class="content">
                                    <h3><a href="{{ route('serviceDetails') }}">Business Consulting</a></h3>
                    ...
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay=".5s">
                        <div class="service-offer-items">
                            <div class="icon">
                               <img src="{{ asset('assets/img/service/icon/earning.svg') }}" alt="img">
                            </div>
                            <div class="offer-content">
                                <div class="content">
                                    <h3><a href="{{ route('serviceDetails') }}">Financial Planning</a></h3>
                                    <p>We Fixed about your business Solutions</p>
                                </div>
                                <a href="{{ route('serviceDetails') }}" class="arrow-icon"><i class="far fa-arrow-right"></i></a>
                            </div>
                    ...
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="service-offer-items">
                            <div class="icon">
                               <img src="{{ asset('assets/img/service/icon/targeted.svg') }}" alt="img">
                            </div>
                            <div class="offer-content">
                                <div class="content">
                                    <h3><a href="{{ route('serviceDetails') }}">Grow Marketing & Sales</a></h3>
                                    <p>We Fixed about your business Solutions</p>
                                </div>
                                <a href="{{ route('serviceDetails') }}" class="arrow-icon"><i class="far fa-arrow-right"></i></a>
                            </div>
                    ...
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay=".5s">
                        <div class="service-offer-items">
                            <div class="icon">
                               <img src="{{ asset('assets/img/service/icon/technology.svg') }}" alt="img">
                            </div>
                            <div class="offer-content">
                                <div class="content">
                                    <h3><a href="{{ route('serviceDetails') }}">Modernize & Technology</a></h3>
                                    <p>We Fixed about your business Solutions</p>
                                </div>
                                <a href="{{ route('serviceDetails') }}" class="arrow-icon"><i class="far fa-arrow-right"></i></a>
                            </div>
        ...
        <!-- About Section Start --> 
        <section class="about-section-3 section-padding pt-0" id="about">
            <div class="container">
                                ...
                                <div class="about-image-1 wow fadeInUp" data-wow-delay=".3s">
                                   <img src="{{ asset('assets/img/about/03.jpg') }}" alt="img">
                                    <div class="about-image-2">
                                       <img src="{{ asset('assets/img/about/04.jpg') }}" alt="img">
                                    </div>
                                </div>
                                <div class="experience-items float-bob-x wow fadeInLeft" data-wow-delay=".5s">
                                    <h6>
        ...
        <!-- Team Section Start -->
        <section class="team-section fix footer-bg section-padding" id="team">
            <div class="container">
                <div class="section-title text-center">
                    <span class="sub-content wow fadeInUp">
                       <img src="{{ asset('assets/img/bale.png') }}" alt="img">
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                        <div class="team-card-items">
                            <div class="team-image">
                               <img src="{{ asset('assets/img/team/06.jpg') }}" alt="team-img">
                                <div class="icon-list">
                                    <ul>
                                        <li>
                            ...
                            <div class="team-content">
                                <h4><a href="{{ route('teamDetails') }}">Eduardo D. Howard</a></h4>
                                <p>CEO & Founder</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                        <div class="team-card-items">
                            <div class="team-image">
                               <img src="{{ asset('assets/img/team/07.jpg') }}" alt="team-img">
                                <div class="icon-list">
                                    <ul>
                                        <li>
                                            <a href="#"><i class="fab fa-facebook-f"></i></a>
                            ...
                            <div class="team-content">
                                <h4><a href="{{ route('teamDetails') }}">Jeremiah D. Marshall</a></h4>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".6s">
                        <div class="team-card-items">
                            <div class="team-image">
                               <img src="{{ asset('assets/img/team/08.jpg') }}" alt="team-img">
                                <div class="icon-list">
                                    <ul>
                                        <li>
                                            <a href="#"><i class="fab fa-facebook-f"></i></a>
                            ...
                            <div class="team-content">
                                <h4><a href="{{ route('teamDetails') }}">Jeremy B. Forsberg</a></h4>
                                <p>Senior Manager</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".8s">
                        <div class="team-card-items">
                            <div class="team-image">
                               <img src="{{ asset('assets/img/team/09.jpg') }}" alt="team-img">
                                <div class="icon-list">
                                    <ul>
                                        <li>
                                            <a href="#"><i class="fab fa-facebook-f"></i></a>
                            ...
                            <div class="team-content">
                                <h4><a href="{{ route('teamDetails') }}">Duane V. McCormick</a></h4>
        ...
        <section class="business-boost-section section-padding pt-0">
            <div class="container">
                <div class="business-boost-wrapper">
                    <div class="row g-4 align-items-center">
                        <div class="col-lg-6">
                            <div class="business-boost-content">
                               <img src="{{ asset('assets/img/start-business-men.png') }}" alt="img" class="wow fadeInUp" data-wow-delay=".2s">
                                ...
                                <a href="{{ route('contact') }}" class="theme-btn bg-2 wow fadeInUp" data-wow-delay=".7x">Get Started Now <i class="far fa-arrow-right"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-6 mt-4 wow fadeInUp" data-wow-delay=".4s">
                            <div class="video-image">
                               <img src="{{ asset('assets/img/video-bg-popup.jpg') }}" alt="img">
                                <div class="video-box">
        ...
        <section class="grow-business-section fix section-padding pt-0">
            <div class="container">
                <div class="grow-business-wrapper-2">
                    <div class="row g-4 justify-content-between">
                        <div class="col-lg-5">
                            <div class="grow-business-image wow fadeInUp" data-wow-delay=".3s">
                               <img src="{{ asset('assets/img/grow/02.jpg') }}" alt="img">
                                <div class="grap-shape float-bob-x wow fadeInLeft" data-wow-delay=".5s">
        ...
        <section class="working-process-section section-padding pt-0">
            <div class="container">
                <div class="section-title text-center">
                    <span class="sub-content wow fadeInUp">
                       <img src="{{ asset('assets/img/bale.png') }}" alt="img">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="work-process-content">
                                <div class="work-process-items wow fadeInUp" data-wow-delay=".3s">
                        ...
                        <div class="col-lg-6">
                            <div class="work-process-image wow fadeInUp" data-wow-delay=".4s">
                               <img src="{{ asset('assets/img/business-mens-grsl.jpg') }}" alt="img">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row justify-content-between align-items-center g-4">
                        <div class="col-lg-6">
                            <div class="swiper testimonial-slider-3">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="testimonial-content">
                                            ...
                                            <p>“    we denounce with right indignation and dislike men who are so beguile and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee “</p>
                                            <div class="star">
                                ...
                                <div class="swiper-dot-2 pt-3 ps-1">
                                    <div class="dot"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-5 wow fadeInUp" data-wow-delay=".4s">
                            <div class="testimonial-image">
                               <img src="{{ asset('assets/img/testimonial/01.jpg') }}" alt="img">
                                <div class="card-shape-1 float-bob-x">
                                   <img src="{{ asset('assets/img/testimonial/testimonial-card1.png') }}" alt="shape-img">
                                </div>
                                <div class="card-shape-2 float-bob-y">
                                   <img src="{{ asset('assets/img/testimonial/testimonial-card2.png') }}" alt="shape-img">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="news-card-items">
                            <div class="news-image bg-cover" style="background-image: url('{{ asset('assets/img/news/04.jpg') }}')"></div>
                            <div class="news-content">
                                <p>November 25, 2024</p>
                                <h4><a href="{{ route('newsDetails') }}">Revealing Images With  Animations Gradients, Blend Modes Cool</a></h4>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                        <div class="news-card-items">
                            <div class="news-image bg-cover" style="background-image: url('{{ asset('assets/img/news/05.jpg') }}')"></div>
                            <div class="news-content">
                                <p>November 25, 2024</p>
                                <h4><a href="{{ route('newsDetails') }}">List of 5 ways Generating Real-Time Audio Sentiment Analysis With</a></h4>
                                <a class="link-btn" href="{{ route('newsDetails') }}">Read More<i class="far fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".7s">
                        <div class="news-card-items">
                            <div class="news-image bg-cover" style="background-image: url('{{ asset('assets/img/news/06.jpg') }}')"></div>
                            <div class="news-content">
                                <p>November 25, 2024</p>
                                <h4><a href="{{ route('newsDetails') }}">September Of Never Ending Adventures (2024 Wallpapers Edition)</a></h4>
                                <a class="link-btn" href="{{ route('newsDetails') }}">Read More<i class="far fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
