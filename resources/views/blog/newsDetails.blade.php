                            ...
                            <div class="blog-post-details border-wrap mt-0">
                                <div class="single-blog-post post-details mt-0">
                                    <div class="post-content pt-0">
                                        <h2 class="mt-0">Your Guide To Becoming A Preferred Shipper</h2>
                                       ...
                                       <img src="{{ asset('assets/img/news/post-4.jpg') }}" alt="blog__img" class="single-post-image">
                                        ...
                                        <img class="alignleft" src="{{ asset('assets/img/news/post-10.jpg') }}" alt="blog__img">
                                        <p>
                                            With worldwide annual spend on digital advertising surpassing $325 billion, it’s no surprise that different 
                                            approaches to online marketing are becoming available. One of these new approaches is performance marketing 
                                            or digital performance marketing. Keep reading to learn all about performance marketing
                                ...
                                <div class="row tag-share-wrap">
                                    <div class="col-lg-8 col-12">
                                        <h4>Releted Tags</h4>
                                        <div class="tagcloud">                                   
                                            <a href="{{ route('newsDetails') }}">Course</a>
                                            <a href="{{ route('newsDetails') }}">Education</a>
                                            <a href="{{ route('newsDetails') }}">Training</a>
                                        </div>
                                    </div>
                                ...
                                <div class="comments-section-wrap">
                                    <div class="comments-heading pt-5">
                                        <h3>03 Comments</h3>
                                    </div>
                                    <ul class="comments-item-list">
                                        <li class="single-comment-item">
                                            <div class="author-img">
                                               <img src="{{ asset('assets/img/news/author-1.jpg') }}" alt="img">
                                            </div>
                                        ...
                                        <li class="single-comment-item">
                                            <div class="author-img">
                                               <img src="{{ asset('assets/img/news/author-2.jpg') }}" alt="img">
                                            </div>
                                            <div class="author-info-comment">
                                                <div class="info">
                                            ...
                                            <ul class="replay-comment">
                                                <li class="single-comment-item">
                                                    <div class="author-img">
                                                       <img src="{{ asset('assets/img/news/author-3.jpg') }}" alt="img">
                                                    </div>
                                                    <div class="author-info-comment">
                                                        <div class="info">
