        ...
        <div class="dropdown-body header-notification-scroll relative py-4 px-5"
          ...
          <div class="card mb-2">
            <div class="card-body">
              <div class="flex gap-4">
                <div class="shrink-0">
                  <img class="img-radius w-12 h-12 rounded-0" src="{{ asset('assets/admin-assets/images/user/avatar-1.jpg')}}" alt="Generic placeholder image" />
                </div>
                <div class="grow">
          ...
          <div class="card mb-2">
            <div class="card-body">
              <div class="flex gap-4">
                <div class="shrink-0">
                  <img class="img-radius w-12 h-12 rounded-0" src="{{ asset('assets/admin-assets/images/user/avatar-2.jpg')}}" alt="Generic placeholder image" />
                </div>
                <div class="grow">
          ...
          <div class="card mb-2">
            <div class="card-body">
              <div class="flex gap-4">
                <div class="shrink-0">
                  <img class="img-radius w-12 h-12 rounded-0" src="{{ asset('assets/admin-assets/images/user/avatar-3.jpg')}}" alt="Generic placeholder image" />
                </div>
                <div class="grow ms-3">
          ...
          <div class="card mb-2">
            <div class="card-body">
              <div class="flex gap-4">
                <div class="shrink-0">
                  <img class="img-radius w-12 h-12 rounded-0" src="{{ asset('assets/admin-assets/images/user/avatar-4.jpg')}}" alt="Generic placeholder image" />
                </div>
                <div class="grow ms-3">
          ...
          <div class="card mb-2">
            <div class="card-body">
              <div class="flex gap-4">
                <div class="shrink-0">
                  <img class="img-radius w-12 h-12 rounded-0" src="{{ asset('assets/admin-assets/images/user/avatar-5.jpg')}}" alt="Generic placeholder image" />
                </div>
                <div class="grow ms-3">
                ...
                <div class="table-responsive">
                  <table class="table table-hover">
                    <tbody>
                      <tr class="unread">
                        <td>
                           <img class="rounded-full max-w-10" style="width: 40px" src="{{ asset('assets/admin-assets/images/user/avatar-1.jpg')}}" alt="activity-user" />
                        </td>
                        <td>
                      ...
                      <tr class="unread">
                        <td>
                          <img class="rounded-full max-w-10" style="width: 40px" src="{{ asset('assets/admin-assets/images/user/avatar-2.jpg')}}" alt="activity-user" />
                        </td>
                        <td>
                      ...
                      <tr class="unread">
                        <td>
                          <img class="rounded-full max-w-10" style="width: 40px" src="{{ asset('assets/admin-assets/images/user/avatar-3.jpg')}}" alt="activity-user" />
                        </td>
                        <td>
